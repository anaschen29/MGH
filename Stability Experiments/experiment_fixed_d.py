...
def save_data(N, iterations_per_n, d, step_size, n_axis, results):
    with open('Outputs/results_fixed_d.txt', 'a') as file:
        file.write(f'Experiment N={D}, iterations_per_n = {iterations_per_n}, d = {d}, step_size = {step_size} \n')
...
def power_law_fit(n_axis, results):
...
#    save_data(D, iterations_per_n, n, step_size, n_axis, results)
#    power_law_fit(n_axis, results)
